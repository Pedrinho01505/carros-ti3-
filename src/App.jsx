    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex max-w[920px]">
        ...
        <img src={iconSuvs} alt="icone dos carros SUVs" className="mb-7"/>
          <h2 className="font-shoulders mb-7 uppercase uppercase text-4xl font-bold text-offwhitebg">SUVs</h2>
        ...
        <img src={iconLuxury} alt="icone dos carros de luxo" className="mb-7"/>
          <h2 className="font-shoulders mb-7 uppercase uppercase text-4xl font-bold text-offwhitebg">Luxuosos</h2>
          ...
          <a className="font-lexend bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-dark-green border-2 border-offwhitebg hover:bg-dark-green hover:text-offwhitebg" href="https://www.webmotors.com.br/carros-de-luxo/carros/estoque?tipoveiculo=carros&necessidade=Carros%20de%20luxo" target="_blank">Ver mais</a>
        </div>
      </section>
    </main>
  )
