    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        ...
        <img src={iconLuxury} alt="icone dos carros de luxo" className="mb-7"/>
          ...
          <a className="font-lexend bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-dark-green" href="https://www.webmotors.com.br/carros-de-luxo/carros/estoque?tipoveiculo=carros&necessidade=Carros%20de%20luxo" target="_blank">Ver mais</a>
        </div>
      </section>
    </main>
  )
